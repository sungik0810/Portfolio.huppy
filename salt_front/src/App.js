...
import { changePeoplePhoto, loginCheckOk, setResize } from "./store/store";

axios.defaults.timeout = 0;
const LOCAL_HOST = "http://192.168.123.117:8080";
export { LOCAL_HOST };
function App() {
  ...
  useEffect(() => {
    ...
    // setInterval(() => {
    //   axios.get("/timer").then((result) => {
    //     setExtraTime(result.data.time);
    //   });
    // }, 1000);
  }, []);
  return (
